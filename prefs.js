...
export default class MediaControlsPreferences extends ExtensionPreferences {
    ...
    async fillPreferencesWindow(window) {
        ...
        this.initWidgets();
        this.bindSettings();
        this.initSpectrumVisualizerPref();
     ...
     * @returns {void}
     */
    initSpectrumVisualizerPref() {
        const spectrumGroup = new Adw.PreferencesGroup({
            title: _("Spectrum Visualizer"),
            description: _("Animated frequency spectrum shown in the popup menu"),
        });
        const spectrumRow = new Adw.SwitchRow({
            title: _("Show Spectrum Visualizer"),
            subtitle: _("Display animated bars that react to playback state"),
        });
        spectrumRow.active = this.settings.get_boolean("show-spectrum-visualizer");
        const bindingFlags = Gio.SettingsBindFlags.DEFAULT | Gio.SettingsBindFlags.NO_SENSITIVITY;
        this.settings.bind("show-spectrum-visualizer", spectrumRow, "active", bindingFlags);
        spectrumGroup.add(spectrumRow);
        this.generalPage.add(spectrumGroup);
    }
