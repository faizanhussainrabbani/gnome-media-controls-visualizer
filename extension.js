...
export default class MediaControls extends Extension {
    ...
    initSettings() {
        ...
        this.showSpectrumVisualizer = this.settings.get_boolean("show-spectrum-visualizer");
        ...
        this.settings.connect("changed::show-spectrum-visualizer", () => {
            this.showSpectrumVisualizer = this.settings.get_boolean("show-spectrum-visualizer");
            this.panelBtn?.updateWidgets(WidgetFlags.MENU_SPECTRUM);
        });
    ...
    destroySettings() {
        ...
        this.showSpectrumVisualizer = null;
